...
export default {
  ...
  [ErrorCodes.MISSING_SONG_CHANNEL]:
    "The music channel has not been set on this server, use /setup and make sure the bot has the necessary permissions.",
  [ErrorCodes.USE_SONG_CHANNEL]:
    "Send the message in {{- song_channel}} so that I can play the song.",
};
