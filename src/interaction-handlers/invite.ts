...
export class Invite extends InteractionHandler {
  ...
  async run (interaction: ButtonInteraction) {
    ...
    const buttons = row.addComponents(new ButtonBuilder().setStyle(ButtonStyle.Link)
      .setLabel('twokei.com')
      .setURL('https://twokei.com/?utm_campaign=invite_button&utm_medium=discord&utm_source=bot'));
