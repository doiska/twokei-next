CREATE TABLE IF NOT EXISTS "analytics_track_info" (
...
CREATE TABLE IF NOT EXISTS "analytics_user_added_tracks" (
...
--> statement-breakpoint
CREATE TABLE IF NOT EXISTS "analytics_user_listened_tracks" (
	"user_id" varchar NOT NULL,
	"track_id" varchar NOT NULL,
	"guild_id" varchar,
	"listened" integer DEFAULT 1,
...
--> statement-breakpoint
CREATE TABLE IF NOT EXISTS "player_embed_arts" (
	"name" varchar,
	"url" varchar PRIMARY KEY NOT NULL,
...
--> statement-breakpoint
CREATE TABLE IF NOT EXISTS "player_song_channels" (
	"guild_id" varchar PRIMARY KEY NOT NULL,
